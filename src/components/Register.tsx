        ...
        <div className='flex flex-col justify-center items-center p-2'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col m-auto mt-4 w-full md:w-1/2 lg:w-1/4 justify-center items-center'>
                <InputElement<IFormInput>
                    ...
                    name='email'
                    register={register}
                    validation={{ required: 'Email is required', pattern: { value: /^[^@ ]+@[^@ ]+\.[^@ .]{2,}$/, message: 'Invalid email address' } }}
                    error={errors.email}
                />
                <InputElement<IFormInput>
                    label='Password'
                    ...
                    type='password'
                    register={register}
                    validation={{ required: 'Password is required', minLength: { value: 8, message: "Minimum length is 8 with a mix of letters, numbers and symbols" } }}
                    error={errors.password}
                />
                {!errors.password && <div className='text-sm text-primaryLight mb-4'>
                ...
                <InputElement<IFormInput>
                    ...
                    validation={{
                        ...
                        minLength: { value: 8, message: 'Minimum length is 8 with a mix of letters, numbers and symbols' },
                        validate: (value) =>
